...
namespace Question_1
{
    public partial class FRM_search : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e){
            ...
            try{
                MySqlDataAdapter adapter = new MySqlDataAdapter("SELECT * FROM final_exam.student_table WHERE student_first_name LIKE '%"+name+
                    "%' OR student_last_name LIKE '%" + name+"%'", conn);
                conn.Open();
