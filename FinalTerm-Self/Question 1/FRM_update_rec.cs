...
namespace Question_1
{
    public partial class FRM_update_rec : Form
    {
        ...
        private void FRM_update_rec_Load(object sender, EventArgs e){txtbx_id.Focus();}
        private void btn_update_Click(object sender, EventArgs e){
            ...
            if(conn.State == ConnectionState.Open){
                ...
                string sql = "UPDATE `final_exam`.`student_table` SET `student_first_name` = '"+first_name+"', `student_last_name` = '"
                    +last_name+"', `student_age`="+age+" WHERE (`student_id` = '" + id+"');";
